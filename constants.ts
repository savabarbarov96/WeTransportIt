...
export const PRIMARY_CITIES = ["Стара Загора", "Пловдив", "София", "Казанлък", "Нова Загора"];
...
export const FAQ_ITEMS: FaqItem[] = [
    { question: "Колко струва преместване на апартамент?", answer: "Цената зависи от обема на вещите, броя етажи и разстоянието. Обадете се за индивидуална оферта." },
