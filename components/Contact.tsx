                        ...
                        {submitted ? (
                            ...
                            <form onSubmit={handleSubmit} noValidate>
                                ...
                                <div className="mt-6">
                                    ...
                                    <textarea id="message" name="message" rows={6} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Опишете каква услуга ви трябва..." value={formData.message} onChange={handleChange}></textarea>
                                </div>
                                <div className="mt-6">
